...
function setUpStartCards(){
    cards = [
        {
            name: 'Эрл грей',
            url: './assets/earl-grey.png',
            id: 0,
            disc: 'Классика',
            provider: 'ИП "Фруктовый мир"'
        },
        {
            name: 'Медведь',
            url: './assets/bear.png',
            id: 1,
            disc: 'Ты же наш сибирский!',
            provider: 'ОАО "ааооо"'
        },
        {
            name: 'Эсса',
        ...
        {
            name: 'Я приехала в ',
            url: './assets/saray.png',
            id: 3,
            disc: 'Так и знала от*****, словно сердце чуяло',
            provider: 'Колхоз имени мичурина'
        },
        {
            name: 'Клубника',
            url: './assets/strawberry.png',
            id: 4,
            disc: 'Хорошо со сливками идет',
            provider: 'ИП "Фруктовый мир"'
        },
    ];
